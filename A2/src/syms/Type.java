...
public abstract class Type 
{
     ...
     * @return true iff a compatible type and vaue is an element
     */
    ...
    public static class PointerType extends AddressType {
         ...
         */
        @Override
        public PointerType resolveType( Location loc ) {
            if( !resolved ) {
        ...
        public void resolveBaseType(Location loc) {
            baseType = baseType.resolveType( loc );
        }
        @Override
        public Type getBaseType() {
            if( !baseType.resolved ) {
                baseType = baseType.resolveType(ErrorHandler.NO_LOCATION);
            }
            return baseType;
        }
    ...
    public static class RecordType extends Type {
        ...
        public RecordType() {
            ...
            this.loc = ErrorHandler.NO_LOCATION;
        ...
        public Type resolveType( Location loc ) {
            if( !resolved ) {
                ...
                for( Field field : fieldList ) {
                    ...
                    // System.out.println( "Field " + field.getId() + ":" + fieldType );
                    offset += fieldType.getSpace();
                }
                space = offset;
                resolved = true;
            }
            // System.out.println( "Resolved " + name + " to " + this );
            return this;
        }
        @Override
        public String toString() {
